...
export default function JoinSection() {
  return (
    <section id="join" className="py-20 relative bg-gradient-to-b from-[#1a0000]/30 to-[#4d9fff]/50">
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(10)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute rounded-full bg-[#ff6b6b]/10 blur-xl"
            style={{
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#ff6b6b] to-[#4d9fff]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <motion.div
            className="bg-gradient-to-br from-[#ff6b6b]/50 to-[#4d9fff]/50 backdrop-blur-lg rounded-xl p-8 border border-[#ff6b6b]/20"
          ...
          >
            ...
            <motion.a
              ...
              className="inline-flex items-center bg-[#ff6b6b] hover:bg-[#ff6b6b]/80 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300"
          ...
          <motion.div
            className="bg-gradient-to-br from-[#4d9fff]/50 to-[#1a0000]/50 backdrop-blur-lg rounded-xl p-8 border border-[#4d9fff]/20"
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.6 }}
          ...
          >
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center bg-[#4d9fff] hover:bg-[#4d9fff]/80 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
